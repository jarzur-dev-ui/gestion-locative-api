...
/**
 * Schéma d'update : la propriété est immuable (pas de `propertyId`).
 * Les listes `tenantIds` / `guarantorIds` remplacent intégralement les
 * jointures existantes (le service supprime puis réinsère dans une
 * transaction).
 */
